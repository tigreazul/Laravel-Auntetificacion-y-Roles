                        ...
                        <li class="header-notification">
                            <div class="dropdown-primary dropdown">
                                ...
                                <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                    ...
                                    <li>
                                        <div class="media">
                                        <img class="img-radius" src="{{ asset('theme_admin/images/avatar-4.jpg') }}" alt="Generic placeholder image">
                                    ...
                                    <li>
                                        <div class="media">
                                        <img class="img-radius" src="{{ asset('theme_admin/images/avatar-3.jpg') }}" alt="Generic placeholder image">
                                        <div class="media-body">
                        ...
                        <div class="main-friend-list">
                            <div class="media userlist-box waves-effect waves-light" data-id="1" data-status="online" data-username="Josephin Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius img-radius" src="{{ asset('theme_admin/images/avatar-3.jpg') }}" alt="Generic placeholder image ">
                            ...
                            <div class="media userlist-box waves-effect waves-light" data-id="2" data-status="online" data-username="Lary Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="{{ asset('theme_admin/images/avatar-2.jpg') }}" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box waves-effect waves-light" data-id="3" data-status="online" data-username="Alice">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="{{ asset('theme_admin/images/avatar-4.jpg') }}" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box waves-effect waves-light" data-id="4" data-status="offline" data-username="Alia">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="{{ asset('theme_admin/images/avatar-3.jpg') }}" alt="Generic placeholder image">
            ...
            <div class="main-friend-chat">
                <div class="media chat-messages">
                    <a class="media-left photo-table" href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="{{ asset('theme_admin/images/avatar-2.jpg') }}" alt="Generic placeholder image">
                    </a>
                                                        ...
                                                        <div class="latest-update-box">
                                                            <div class="row p-t-20 p-b-30">
                                                                <div class="col-auto text-right update-meta p-r-0">
                                                                    <img src="{{ asset('theme_admin/images/avatar-4.jpg') }}" alt="user image" class="img-radius img-40 align-top m-r-15 update-icon">
                                                                </div>
                                                                <div class="col p-l-5">
                                                        ...
                                                        <table class="table table-hover m-b-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>Sofa</td>
                                                                    <td>#PHD001</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d2b3b0b192b5bfb3bbbefcb1bdbf">[email&#160;protected]</a></td>
                                                                ...
                                                                <tr>
                                                                    <td>Computer</td>
                                                                    <td>#PHD002</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="dfbcbbbc9fb8b2beb6b3f1bcb0b2">[email&#160;protected]</a></td>
                                                                ...
                                                                <tr>
                                                                    <td>Mobile</td>
                                                                    <td>#PHD003</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c4b4b5b684a3a9a5ada8eaa7aba9">[email&#160;protected]</a></td>
                                                                    <td><label class="label label-danger">Out Stock</label></td>
                                                                    <td>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                ...
                                                                <tr>
                                                                    <td>Coat</td>
                                                                    <td>#PHD004</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="690b0a1a290e04080005470a0604">[email&#160;protected]</a></td>
                                                                    <td><label class="label label-success">In Stock</label></td>
                                                                    <td>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                ...
                                                                <tr>
                                                                    <td>Shoes</td>
                                                                    <td>#PHD006</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c6b6b7b486a1aba7afaae8a5a9ab">[email&#160;protected]</a></td>
                                                                    <td><label class="label label-danger">Out Stock</label></td>
                                                                    <td>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/a2bd7673/cloudflare-static/rocket-loader.min.js" data-cf-settings="8f68cca9f211ae1c772449e8-|49" defer=""></script></body>
</html>
