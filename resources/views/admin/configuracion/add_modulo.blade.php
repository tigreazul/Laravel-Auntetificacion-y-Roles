                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form id="main" method="POST" action="{{ route('admin.modulo_add_store') }}" novalidate="">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a type="submit" class="btn btn-sm btn-default m-b-0"><i class="fa fa-reply"></i> Volver</a>
                                    </div>
                                </div>
                            </form>
                        </div>
