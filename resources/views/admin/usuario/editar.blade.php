                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="nombre" name="nombre" required onkeypress="return soloLetras(event)" value="{{ isset($usuarios->nombreUsuario)?$usuarios->nombreUsuario:''}}">
                                        ...
                                        <div class="tab-pane" id="profile1" role="tabpanel">
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="Usuario" name="usuario" required value="{{ isset($usuarios->dni)?$usuarios->nombreUsuario:'' }}">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="cargo" class="form-control" id="cargo">
                                                            ...
                                                            @foreach($cargo as $carg)
                                                                <option value="{{ $carg->codigo }}" data-id="{{ $carg->codigo }}" {{ isset($usuarios->idCargo)?( $usuarios->idCargo == $carg->codigo ?'selected':'' ):'' }}>{{ $carg->valor }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="agestion" class="form-control" id="agestion">
                                                            <option value="">[SELECCIONE]</option>
                                                            <option value="2018" {{ isset($usuarios->anioGestion)?( $usuarios->anioGestion == '2018'?'selected':'' ):'' }}>2018</option>
                                                            <option value="2019" {{ isset($usuarios->anioGestion)?( $usuarios->anioGestion == '2019'?'selected':'' ):'' }}>2019</option>
                                                            <option value="2020" {{ isset($usuarios->anioGestion)?( $usuarios->anioGestion == '2020'?'selected':'' ):'' }}>2020</option>
                                                            <option value="2021" {{ isset($usuarios->anioGestion)?( $usuarios->anioGestion == '2021'?'selected':'' ):'' }}>2021</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
